            ...
            <Row id={'cards-row'} className={'border border-4'}>
                ...
                <Row xs={1} sm={2} md={3} className="g-4">
                    ...
                    <Col className={'card-col'}>
                        <Card className={'card-position border'}>
                    ...
                    <Col className={'card-col'}>
                        <Card className={'card-position border'}>
                            <Card.Img variant="top"
                                      src={'https://games.mail.ru/pre_0x736_resize/hotbox/content_files/' +
                    ...
                    <Col className={'card-col'}>
                        <Card className={'card-position border'}>
                            <Card.Img variant="top" src={'https://cdn.kanobu.ru/articles/' +
                                'pics/tmp/images/2022/12/7/1c99201c-c298-4661-9ef4-c127de3b09be.webp'}
                                      className={'card-img'}/>
                            <Card.Body className={'card-body'}>
