            ...
            <Row id={'steps-block-row'}>
                <Col className={'steps-block-col'}>
                    ...
                    <p className={'steps-text'}>
                        Create an account. It's very easy thanks to a simplified menu and detailed instructions!
                    </p>
                </Col>
                <Col className={'steps-block-col'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                         className="bi bi-2-circle icon-color" viewBox="0 0 16 16">
                        <path
                ...
                <Col className={'steps-block-col'}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                         className="bi bi-3-circle icon-color" viewBox="0 0 16 16">
                        <path
