...
const offerPagesCardsReducer = (state = initialState, action) => {

    switch (action.type) {

        case offerPageUpdateForms:
            if (action.formName === 'offerPageCardTitle') {
                state.offerPageCardsForms.cardTitleForm = action.text;
            } else if (action.formName === 'offerPageCardText') {
                state.offerPageCardsForms.cardTextForm = action.text;
            }
            break

        case offerPageAddCard:
            let newOfferPageCard = {
                id: state.pagesData[action.gameOfferSelector].offerCardsData.length,
                title: state.offerPageCardsForms.cardTitleForm,
                text: state.offerPageCardsForms.cardTextForm
            }

            state.pagesData[action.gameOfferSelector].offerCardsData.push(newOfferPageCard);
            state.offerPageCardsForms.cardTitleForm = '';
            state.offerPageCardsForms.cardTextForm = '';
            break
